...
{{--</div>--}}
{{--<div class="form-group">--}}
{{--    <label for="specializeSelect">Specialized Checker:</label>--}}
{{--    <select class="input-group" id="specializeSelect">--}}
{{--        <option value="">Check Specialized</option>--}}
{{--        @foreach(\App\Models\Specialize::all() as $specialize)--}}
{{--            <option value="{{ $specialize->id }}" @if( $specialize->id) selected @endif>{{ $specialize->specialized_name }}</option>--}}
{{--        @endforeach--}}
{{--    </select>--}}
{{--</div>--}}
<div class="form-group">
...
{{--    <input type="hidden" id="specializeId" name="specializes_id" value="">--}}
</form>
...
<script>
    ...
    // document.getElementById('specializeSelect').addEventListener('change', updateHiddenForm);
    ...
    function updateHiddenForm() {
        ...
        // document.getElementById('specializeId').value = document.getElementById('specializeSelect').value;
